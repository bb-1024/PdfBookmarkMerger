...
> repository (`v1.0.0` / `v1.1.0` / `v1.2.0` / `v1.2.1` / `v1.2.2` / `v1.2.3` / `v1.3.0` / `v1.3.1`). Every claim about which version
...
tests/
  ...
  PdfBookmarkMerger.App.Tests/          App-layer ViewModel tests (132)
...
| [05-version-history.md](05-version-history.md) | Design-level diffs across v1.0.0 → v1.1.0 → v1.2.0 → v1.2.1 → v1.2.2 → v1.2.3 → v1.3.0 → v1.3.1, and how to verify them |

## 6. How this document is grounded

The content here was verified against the actual repository state as follows:

- Current-design descriptions: read directly from the relevant source file at HEAD (`v1.3.1`)
