...
> (`v1.0.0` / `v1.1.0` / `v1.2.0` / `v1.2.1` / `v1.2.2` / `v1.2.3` / `v1.3.0` / `v1.3.1`)の
...
tests/
  ...
  PdfBookmarkMerger.App.Tests/          App層ViewModelのテスト(132件)
...
| [05-version-history.md](05-version-history.md) | v1.0.0→v1.1.0→v1.2.0→v1.2.1→v1.2.2→v1.2.3→v1.3.0→v1.3.1の設計上の差分と、その確認方法 |

## 6. この文書の裏付け方法

本ドキュメント群の内容は、以下の方法で実際のリポジトリ状態から確認しています。

- 現行設計の記述: HEAD(`v1.3.1`)時点の該当ソースファイルを直接参照
